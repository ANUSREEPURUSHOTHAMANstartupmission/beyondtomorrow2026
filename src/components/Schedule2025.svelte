<script>
    ...
    async function loadData(){
      ...
      loading = true;
      let data = await fetch(`https://events.startupmission.in/api/event/beyond_tomorrow_2025/agenda/venue`).then(response => response.json());
                                  ...
                                  {#each speaker_list as {name, designation, organisation, photo, linkedin}}
                                    <div class="flex items-center space-x-4 mb-3 pr-3 md:w-1/2">
                                      ...
                                      <div>
                                        ...
                                        <div class=" text-[12px]  text-[#e7420baf]">{designation}</div>
                                        <div class="text-[12px]  text-[#e7420baf]">{organisation ?? ""}</div>
                                      </div>
                                    </div>
                                  {/each}
                                </div>
