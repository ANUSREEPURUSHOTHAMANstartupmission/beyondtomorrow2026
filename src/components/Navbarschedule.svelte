...
<div id="navbar" class="w-64 min-h-screen  sm:w-full sm:min-h-0 sm:h-20 p-8 sm:py-3 bg-white  left-0 top-0 
    sm:items-center
    ...
    <div class="flex bg-white top-4 absolute sm:hidden">    
      <button on:click="{()=> menu_open = !menu_open }" class="z-50 bg-white cursor-pointer fixed right-5 w-8 h-8 mb-8 text-xl ml-auto transition duration-150 hover:shadow leading-none px-2 py-1  rounded bg-white block outline-none focus:outline-none" type="button">
    ...
    <div class="w-screen sm:mt-0 mt-16 container mx-auto sm:flex sm:items-center sm:justify-between">
      <div class=" md:mx-10 m-0  font-medium w-fit p-0 rounded-md flex items-center justify-center">
        ...
        <img src="/img/btlogo_.svg" alt="logo" class=" {scrolled?'h-12':'h-16'}">
      </div>
      ...
      <nav>
        <ul class="sm:flex md:text-xs  w-full">
          ...
          <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-3 py-2 transform hover:text-[#e82277] transition duration-500 hover:scale-100" >
            ...
            <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-3 py-2 transform hover:text-[#e82277] transition duration-500 hover:scale-100">
              <a href="/2024Kochiedition#about" class=" text-[#591CBC] font-bold hover:text-[#e82277] font-data uppercase text-sm ">About</a>
            </li>
         
            <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-3 py-2 transform hover:text-[#e82277] transition duration-500 hover:scale-100">
              <a href="/2024Kochiedition#Speakers" class=" text-[#591CBC] font-bold hover:text-[#e82277] font-data uppercase text-sm ">Speakers</a>
            </li>

            <li on:click="{()=> menu_open = !menu_open }"  class="w-fit px-3 py-2 transform hover:text-[#e82277] transition duration-500 hover:scale-100">
              <a href="/2024Schedule" class=" text-[#591CBC] font-bold hover:text-[#e82277] font-data uppercase text-sm ">Schedule</a>
            </li>
          
            <li on:click="{()=> menu_open = !menu_open }" class="w-fit px-3 py-2 transform hover:text-[#e82277] transition duration-500 hover:scale-100">
              <a href="/2024Kochiedition#contact" class=" text-[#591CBC] font-bold hover:text-[#e82277] font-data uppercase text-sm">Contact</a>
            </li>
           <!-- <li>
...
<main class="w-full fixed bg-white z-40 {scrolled?'flex':'hidden'}" >
  <div class="flex sm:hidden" >        
    <img src="/img/btlogo_.svg" alt="Logo" class="object-contain h-12 px-2">
    <button on:click="{()=> menu_open = !menu_open }" class="z-50 cursor-pointer fixed right-5 w-10 h-10 text-xl ml-auto transition duration-150 hover:shadow leading-none px-2 py-1  rounded bg-white block lg:hidden outline-none focus:outline-none" type="button">
      <span class="block absolute w-6 h-0.5 rounded-sm bg-black top-3 duration-500 { menu_open ? 'opacity-0':'' }" ></span>
      <span class="block absolute w-6 h-0.5 rounded-sm bg-black duration-500 { menu_open ? 'transform rotate-45':'' }"></span>
      <span class="block absolute w-6 h-0.5 rounded-sm bg-black duration-500 { menu_open ? 'transform -rotate-45':'' }"></span>
      <span class="block absolute w-6 h-0.5 rounded-sm bg-black bottom-2.5 duration-500 { menu_open ? 'opacity-0':'' }"></span>
