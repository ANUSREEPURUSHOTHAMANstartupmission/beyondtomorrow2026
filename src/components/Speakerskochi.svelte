<script>
  ...
  onMount(()=>{
    fetch(`https://events.startupmission.in/api/event/beyond-tomorrow/speakers?category=Speakers`)
    ...
    <div class="grid grid-cols-1 gap-3  lg:grid-cols-4 md:gap-10 md:grid-cols-3 sm:gap-5">
      ...
      {#each speakers as {name, designation, organisation, photo, linkedin}}
        ...
        <div class="max-w-[19rem] speaker items-center justify-center">
          ...
          <div class="bg-cover rounded-2xl h-[18rem] items-center justify-center  w-full mx-auto  cursor-pointer bg-center" style={ 'background-image: url(' +photo+');' }>
          ...
          <div class="content">
            ...
            <p class="text-white text-lg">{designation}</p>
            {#if organisation}
