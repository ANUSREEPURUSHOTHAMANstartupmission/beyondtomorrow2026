<script>
    ...
    async function loadData(){
      ...
      loading = true;
      let data = await fetch(`https://events.startupmission.in/api/event/ai-workshop-trivandrum/agenda/venue`).then(response => response.json());
                  ...
                  <div class="flex flex-col md:flex-row md:space-x-5">
                    ...
                    <div class="w-full divide-y divide-gray-600 space-y-4 mb-3">
                        ...
                        <div class=" w-full pt-3">
                          ...
                          <div class="text-[15px]  font-bold max-w-xl "><p class="text-yellow-500">{name}</p></div>
